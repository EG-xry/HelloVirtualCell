...
perturb_targets = {
    "TF调控":         # IRF2, CEBPB, YAP1, TEAD1, AP-1 家族（共 40 sgRNA）
    "β3信号下游":     # FAK, Src, ILK, RhoA, Rac1, Akt1, PI3K-p110α（共 50 sgRNA）
    "IFN通路":        # cGAS, STING, MAVS, IRF3, IRF7, IFNAR1/2（共 30 sgRNA）
    "补体系统":       # C3, C5aR1, CR3, CFH, CFI（共 20 sgRNA）
    "凋亡/坏死":      # RIPK3, MLKL, Casp1, NLRP3（共 20 sgRNA）
    "阴性对照":       # 40 non-targeting sgRNA（用于 FDR 控制）
}
